...
import { fetchCurrentRevisionEdl, setCurrentRevisionEdl } from "../../../../utilitaires/serveurApi";
...
class EtatDesLieux extends React.Component {
  ...
  componentDidMount = () => {
    if (this.props.croixRouges) {
      this.setState({ croixRouges: this.props.croixRouges })
      return
    }

    fetchCurrentRevisionEdl(this.props.userId)
      .then(etatDesLieux => {
  ...
  render() {
    ...
    return (
      <div className="etatDesLieux">
        ...
        <p>Ci-dessous vous trouverez l'état des lieux effectué par le garagiste lorsqu'il est venu récupérer votre véhicule.</p>
